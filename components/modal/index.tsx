...
export const Modal = ({title, description, primaryAction, primaryText, secondaryText, secondaryAction } : Props) => {
  const isPrimaryActionLink = typeof primaryAction === 'string'
  const isSecondaryActionLink = typeof secondaryAction === 'string'
